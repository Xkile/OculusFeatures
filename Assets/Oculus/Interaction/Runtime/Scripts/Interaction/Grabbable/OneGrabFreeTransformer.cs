...
namespace Oculus.Interaction
{
    ...
    public class OneGrabFreeTransformer : MonoBehaviour, ITransformer
    {
        ...
        {
            //Edit - trying to rotate on one axis and making a knob (21 Sept 2022)
            ...
            */
            ...
            Pose grabPoint = _grabbable.GrabPoints[0];
            var targetTransform = _grabbable.Transform;
            var rotationTemp = grabPoint.rotation * _grabDeltaInLocalSpace.rotation;
            if (targetTransform.gameObject.layer ==9)
            {
                targetTransform.localRotation = Quaternion.Euler(rotationTemp.z * 400, 0,  0);
            }
            else
            {
                targetTransform.localRotation = Quaternion.Euler(0, rotationTemp.z * 400, 0);
            }
